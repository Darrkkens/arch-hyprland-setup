# Arch + Hyprland Setup (legado)

> [!NOTE]
> Esta é a configuração antiga, baseada em Arch Linux + Hyprland + Waybar.
> O sistema foi migrado para Arch + Noctalia (CachyOS). Veja o [README principal](../README.md).
